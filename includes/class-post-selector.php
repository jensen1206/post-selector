...
class Post_Selector {
	...
	public function __construct() {
		if ( defined( 'POST_SELECTOR_VERSION' ) ) {
			$this->version = POST_SELECTOR_VERSION;
		} else {
			$this->version = '1.0.0';
		}
		$this->plugin_name = 'post-selector';
	...
	private function define_admin_hooks() {
		...
		$plugin_admin = new Post_Selector_Admin( $this->get_plugin_name(), $this->get_version() );
